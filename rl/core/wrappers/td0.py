...
class TD0Agent(Agent):
    ...
    def __init__(self, env, gamma=0.99, alpha=0.1, epsilon=0.1, epsilon_decay=0.995, epsilon_min=0.01, episodes=1000, **kwargs):
